  ...
  */
  ...
  var Editor = /** @class */ (function () {
      function Editor(context) {
          ...
          this.context.memo('help.js.undo', this.lang.qna.undo);
          this.context.memo('help.js.redo', this.lang.qna.redo);
          this.context.memo('help.js.tab', this.lang.qna.tab);
          this.context.memo('help.js.untab', this.lang.qna.untab);
          this.context.memo('help.js.insertParagraph', this.lang.qna.insertParagraph);
          this.context.memo('help.js.insertOrderedList', this.lang.qna.insertOrderedList);
          this.context.memo('help.js.insertUnorderedList', this.lang.qna.insertUnorderedList);
          this.context.memo('help.js.indent', this.lang.qna.indent);
          this.context.memo('help.js.outdent', this.lang.qna.outdent);
          this.context.memo('help.js.formatPara', this.lang.qna.formatPara);
          this.context.memo('help.js.insertHorizontalRule', this.lang.qna.insertHorizontalRule);
          this.context.memo('help.js.fontName', this.lang.qna.fontName);
          ...
          for (var idx = 0, len = commands.length; idx < len; idx++) {
              ...
              this.context.memo('help.js.' + commands[idx], this.lang.qna[commands[idx]]);
          }
          ...
          for (var idx = 1; idx <= 6; idx++) {
              ...
              this.context.memo('help.js.formatH' + idx, this.lang.qna['formatH' + idx]);
          }
  ...
  var Buttons = /** @class */ (function () {
      ...
      Buttons.prototype.addToolbarButtons = function () {
          ...
          this.context.memo('button.help.js', function () {
              return _this.button({
                  contents: _this.ui.icon(_this.options.icons.question),
                  tooltip: _this.lang.options.qna,
  ...
  var LinkDialog = /** @class */ (function () {
      function LinkDialog(context) {
          ...
          this.options = context.options;
          this.lang = this.options.langInfo;
          context.memo('help.js.linkDialog.show', this.options.langInfo.qna['linkDialog.show']);
      }
      ...
      HelpDialog.prototype.createShortcutList = function () {
          ...
          return Object.keys(keyMap).map(function (key) {
              ...
              $row.append($$1('<label><kbd>' + key + '</kdb></label>').css({
                  'width': 180,
                  'margin-right': 10
              })).append($$1('<span/>').html(_this.context.memo('help.js.' + command) || command));
              return $row.html();
          }).join('');
      };
      /**
  ...
  $$1.summernote = $$1.extend($$1.summernote, {
      ...
      options: {
          ...
          toolbar: [
              ...
              ['view', ['fullscreen', 'codeview', 'help.js']],
          ],
          // popover
          popatmouse: true,
          popover: {
