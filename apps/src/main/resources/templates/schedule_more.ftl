				...
				<div class="col">
					<div class="row">
						<div class="col-12 col-sm-12 col-md-12 d-flex justify-content-between h3-title-box">
							<h3>Schedule</h3>
<#--							<h3 class="mb-none">Schedule</h3>-->
<#--							<h3 class="dt-none">Schedule</h3>-->
...
<#--								<button type="button" id="scheduleAddBtn" class="btn btn-secondary btn-h4 btn-block" data-toggle="modal" data-target="#schedule-add">일정 추가</button>-->
...
<#--											<button type="button" class="btn btn-primary" onclick="scheduleAdd()">저장</button>-->
<#--										</div>-->
<#--									</div>-->
<#--								</div>-->
<#--							</div>-->
...
<script src="/assets/js/apps/schedule_more.js"></script>
